...
#define KHAOS_VERSION_Test_PRIVATE() SET_VERSION(MAJOR, MINOR, PATCH, TWEAK)
...
#define KHAOS_VERSION_Test_PRIVATE() SET_VERSION(MAJOR, MINOR, PATCH + 1, TWEAK)
...
#undef KHAOS_VERSION_Test_PRIVATE
#define KHAOS_VERSION_Test_PRIVATE() SET_VERSION(MAJOR, MINOR + 1, PATCH, TWEAK)
  CHECK_EQ(1, CHECK_VERSION(Test, >, GET_VERSION_MAJOR(Khaos), GET_VERSION_MINOR(Khaos), GET_VERSION_PATCH(Khaos), GET_VERSION_TWEAK(Khaos)));
#undef KHAOS_VERSION_Test_PRIVATE
#define KHAOS_VERSION_Test_PRIVATE() SET_VERSION(MAJOR + 1, MINOR, PATCH, TWEAK)
  CHECK_EQ(1, CHECK_VERSION(Test, >, GET_VERSION_MAJOR(Khaos), GET_VERSION_MINOR(Khaos), GET_VERSION_PATCH(Khaos), GET_VERSION_TWEAK(Khaos)));
#undef KHAOS_VERSION_Test_PRIVATE
}
...
/* Test CHECK_VERSIONS */
#define KHAOS_VERSION_Test1_PRIVATE() SET_VERSION(MAJOR, MINOR, PATCH, TWEAK)
#define KHAOS_VERSION_Test2_PRIVATE() SET_VERSION(MAJOR + 1, MINOR, PATCH, TWEAK)
