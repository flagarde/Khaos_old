...
#define KHAOS_DEFINE_Test_VERSION_PRIVATE()  SET_VERSION(2, 3, 4, 5)
#define KHAOS_DEFINE_Test2_VERSION_PRIVATE() SET_VERSION(65536, 65536, 65536, 65536) /* Should be seen as 0.0.0.0 */
