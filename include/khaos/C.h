...
#include "CStandards.h"
    ...
    #define KHAOS_C_STANDARD_PRIVATE() (__STDC_VERSION__) /*!< define KHAOS_C_STANDARD */
  #else
    #define KHAOS_C_STANDARD_PRIVATE() KHAOS_STANDARD_C90_PRIVATE() /*!< define KHAOS_C_STANDARD */
  #endif
#else
  /*
